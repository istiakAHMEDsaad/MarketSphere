...
import useBidsData from '../hooks/dataHooks/useBidsData';
...
const MyBids = () => {
  ...
  const { data: bids, isLoading, isError } = useBidsData();
                    ...
                    <tr key={item._id}>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        ...
                        <button
                          ...
                          className='text-gray-500 transition-colors duration-200   hover:text-green-500 focus:outline-none disabled:cursor-not-allowed'
                        >
                          <svg
